...
const tranTxt = {
    'zh-cn': {
        ...
        'Switching to': '正在切换至',
        'Switched to': '已经切换至',
        'Switched danmaku display': '切换弹幕显示',
        'Switched subtitle display': '切换字幕显示',
        Synchronize: '同步',
        Synchronized: '同步的',
        quality: '画质',
        FF: '快进',
    ...
    'zh-tw': {
        ...
        'Switching to': '正在切換至',
        'Switched to': '已經切換至',
        'Switched danmaku display': '切換彈幕顯示',
        'Switched subtitle display': '切換字幕顯示',
        Synchronize: '同步',
        Synchronized: '同步的',
        quality: '畫質',
        FF: '快進',
    ...
    'ja-jp': {
        ...
        'Switched danmaku display': 'コメントの表示を切り替えました',
        'Switched subtitle display': '字幕の表示を切り替えました',
        Synchronize: '同期する',
        Synchronized: '同期しました',
        quality: '品質',
        FF: '早送り',
